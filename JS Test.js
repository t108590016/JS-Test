      ...
      employees.forEach(employee => {
            ...
            employeeType.forEach(type => {
                  if (employee['type'] == type['id']) {
                        const begin_time = type['work_begin'];
                        const end_time = type['work_end'];
                        /*
                        ...
                        */
                        if (begin_time <= end_time)
                              ...
                              if ((time >= begin_time && time <= "23:59:59") || (time <= end_time && time >= "00:00:00"))
                                    number++;
                  }
            });
      });
...
console.log(totalMinute / minute);
